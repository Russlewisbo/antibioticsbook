...
| Test         | Technology | Time to result | Video |
|--------------|------------|----------------|-------|
| Phenotest BC |            |                |       |
| Alfred       |            |                |       |
| dRast        |            |                |       |
...
: Rapid antimicrobial susceptibility testing methods. Adpted from Banerjee and Humphries [@banerjee2021] {#tbl-rapid}
